...
([lesson {n}](#/lesson/18-multiple-objects)) with its own state. Because a class remembers its own state
...
don't need a constructor. [Lesson {n}'s](#/lesson/17-classes-and-objects) constructor form is what you'll
...
The extra `&& intakeState == IntakeState.CLEAR` ([lesson {n}](#/lesson/16-booleans) again) is a
